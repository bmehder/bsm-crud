...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-kfxrp1");
    			add_location(ul, file, 82, 4, 1834);
    			attr_dev(button, "class", "svelte-kfxrp1");
    			add_location(button, file, 94, 4, 2162);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*removeFromList, list, prepareForUpdate*/ 196) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			span.textContent = "X";
    			t3 = space();
    			attr_dev(li, "class", "svelte-kfxrp1");
    			add_location(li, file, 88, 10, 2005);
    			attr_dev(span, "class", "svelte-kfxrp1");
    			add_location(span, file, 89, 10, 2068);
    			attr_dev(div, "class", "svelte-kfxrp1");
    			add_location(div, file, 84, 8, 1881);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*list*/ 4) && t0_value !== (t0_value = /*item*/ ctx[19] + "")) set_data_dev(t0, t0_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:6) {#each list as item, i (i)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*list*/ ctx[2].length && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-kfxrp1");
    			add_location(span, file, 74, 4, 1592);
    			add_location(br, file, 74, 25, 1613);
    			attr_dev(h1, "class", "svelte-kfxrp1");
    			add_location(h1, file, 73, 2, 1583);
    			attr_dev(input_1, "class", "svelte-kfxrp1");
    			add_location(input_1, file, 76, 2, 1648);
    			button.disabled = button_disabled_value = !/*value*/ ctx[1];
    			attr_dev(button, "class", "svelte-kfxrp1");
    			add_location(button, file, 77, 2, 1706);
    			attr_dev(main, "class", "svelte-kfxrp1");
    			add_location(main, file, 72, 0, 1574);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*value*/ 2 && button_disabled_value !== (button_disabled_value = !/*value*/ ctx[1])) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const getListFromLocalStorage = () => {
    		...
    		$$invalidate(2, list = savedListArray);
    	};
